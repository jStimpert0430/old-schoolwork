...
namespace jStimpert_Week13lab {
    ...
    public partial class storeDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(int Product_id, string ProductName, decimal ProductPrice) {
...
namespace jStimpert_Week13lab.storeDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`Product_id` = ?) AND ((? = 1 AND `ProductName` IS" +
                " NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `ProductPrice` IS NULL) OR (`Prod" +
                "uctPrice` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Products` (`Product_id`, `ProductName`, `ProductPrice`) VALUES (?, ?" +
                ", ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `Product_id` = ?, `ProductName` = ?, `ProductPrice` = ? WHE" +
                "RE ((`Product_id` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` " +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::jStimpert_Week13lab.Properties.Settings.Default.storeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Product_id, ProductName, ProductPrice FROM Products";
        ...
        public virtual int Delete(global::System.Nullable<int> Original_Product_id, string Original_ProductName, global::System.Nullable<decimal> Original_ProductPrice) {
        ...
        public virtual int Insert(global::System.Nullable<int> Product_id, string ProductName, global::System.Nullable<decimal> ProductPrice) {
        ...
        public virtual int Update(global::System.Nullable<int> Product_id, string ProductName, global::System.Nullable<decimal> ProductPrice, global::System.Nullable<int> Original_Product_id, string Original_ProductName, global::System.Nullable<decimal> Original_ProductPrice) {
            if ((Product_id.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, global::System.Nullable<decimal> ProductPrice, global::System.Nullable<int> Original_Product_id, string Original_ProductName, global::System.Nullable<decimal> Original_ProductPrice) {
            return this.Update(Original_Product_id, ProductName, ProductPrice, Original_Product_id, Original_ProductName, Original_ProductPrice);
        }
    }
